...
const TARGET_COLUMNS = {
  ...
  wh_stock_mc: [{
    ...
    value: 'assemblypartsnumber',
    label: 'Assembly Parts Number'
  }, {
    value: 'assemblypartsname',
    label: 'Assembly Parts Name'
  }, {
    value: 'reservationno',
  ...
  serial_list: [{
    value: 'IT Controller no.',
    label: 'IT Controller no. (หมายเลขเครื่อง)'
  }, {
    value: 'หมายเลขการผลิต',
    label: 'IMEI (หมายเลขการผลิต)'
  }, {
    value: 'Serial No',
    label: 'Serial No'
  }, {
    ...
    value: 'เลขใบอนุญาตนำเข้า',
    label: 'เลขใบอนุญาตนำเข้า'
  }, {
    value: 'เลขอินวอยซ์นำเข้า',
    label: 'เลขอินวอยซ์นำเข้า'
  }]
};
...
Object.keys(ITC_LABEL_BY_SCOPE).forEach(sc => {
  TARGET_COLUMNS[sc] = [...MASTER_DATA_BASE, {
    value: 'IT Controller no.',
    label: ITC_LABEL_BY_SCOPE[sc]
  }, ...MASTER_DATA_TAIL];
});
const SCOPES = [{
  scope: 'planning',
  ...
  scope: 'master_data',
  label: 'รายการ ทุกชนิด',
  group: 'ข้อมูล'
}, {
  scope: 'master_data:it_controller',
  label: 'รายการ IT Controller',
  group: 'ข้อมูล'
}, {
  scope: 'master_data:swing_motor',
  label: 'รายการ Swing Motor',
  group: 'ข้อมูล'
}, {
  scope: 'master_data:pump_assy_hyd',
  label: 'รายการ Pump Assy HYD',
  group: 'ข้อมูล'
}, {
  scope: 'master_data:motor_propel',
  label: 'รายการ Motor Propel',
  group: 'ข้อมูล'
}, {
  scope: 'master_data:control_valve',
  label: 'รายการ Control Valve',
  group: 'ข้อมูล'
}, {
